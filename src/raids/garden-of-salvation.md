...
* Fireteam shoots the three eyes.

```admonish warning title="Weapon choice"
Don't use a sniper rifle on the eyes.
```

If all three spit collectors have the buff, they will need to rotate one person out with the mote collectors.
